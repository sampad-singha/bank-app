...
{{--        @include('layouts.navbar')--}}
        <div class="container accountNotFoundDiv">
            <div class="row">
                <div class="col-md-12">
                    <div class="error-template">
                        <img src="assets/maze-bank-logo.png" alt="Maze Bank Logo">
                        <div class="error-details">
                            <h3>Account Not Found</h3>
                            Email: <span class="user_mail">{{$user_email}}</span> is not registered into Maze Bank.
                        </div>
                        <div class="error-actions">
                            <a class="" href="{{route('p-account-store')}}">Apply Now</a>
